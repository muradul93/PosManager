 ...
 */
public class InWordsConverter {

    public static String getInWords(double val, String currencySymbol) {
        return "In words: "+ Words.getInstance((long) val).getNumberInWords() + " " + currencySymbol + " Only";
    }
