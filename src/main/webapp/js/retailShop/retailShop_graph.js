...
window.onload = function () {
    ...
    $.ajax({
        url: _ctx+ 'retailShop/getPieChartData'
    }).then(function(data) {
...
//
        ...
        var chart = new CanvasJS.Chart("chartContainer",
            {
                title:{
                    text: "Retail Shop Order Vs Delivered  Amount in Current Month"
                },
...
//
    ...
    /*....................................*/
    $.ajax({
        url: _ctx+ 'retailShop/getSplineChartData'
    }).then(function(data) {
        $.each(data, function (i, item) {
//
