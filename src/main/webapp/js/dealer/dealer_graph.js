...
window.onload = function () {
    ...
    $.ajax({
        url: _ctx+ 'dealer/getPieChartData'
    }).then(function(data) {
...
//
        ...
        var chart = new CanvasJS.Chart("chartContainer",
            {
                title:{
                    text: "Dealer TotalRequisition Vs TotalSales  in Current Month"
                },
...
//
    ...
    /*....................................*/
    $.ajax({
        url: _ctx+ 'dealer/getSplineChartData'
    }).then(function(data) {
        $.each(data, function (i, item) {
//
