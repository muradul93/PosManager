...
function validtionCheck() {
    ...
    if (hr_employee_name==0||dealer_name==0) {
        ...
        if ($('#dealerType').is(':checked')) {
            if (dealer_name == 0) {
                dealer_name_error.text(msgSelect);
    ...
    if(!user_name||!pasword||!re_pasword){
